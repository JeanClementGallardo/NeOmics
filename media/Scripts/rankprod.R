...
write_res_csv(res_lateral, "./Organism__Arabidopsis/Tissue__Lateral_root_cap(IS_CONSTITUTED_BY)/Exp__KNO3_KCL(CONDUCTED_ON)/")
write_res_csv(res_epidermic, "./Organism__Arabidopsis/Tissue__Epidermic_cortex(IS_CONSTITUTED_BY)/Exp__KNO3_KCL(CONDUCTED_ON)/")
write_res_csv(res_pericycle, "./Organism__Arabidopsis/Tissue__Pericycle_root(IS_CONSTITUTED_BY)/Exp__KNO3_KCL(CONDUCTED_ON)/")
write_res_csv(res_protoplast, "./Organism__Arabidopsis/Tissue__Protoplasted_root(IS_CONSTITUTED_BY)/Exp__KNO3_KCL(CONDUCTED_ON)/")
