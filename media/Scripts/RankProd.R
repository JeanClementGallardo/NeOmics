...
library(RankProd)
setwd("/home/jean_clement/PycharmProjects/NeOmics/media/Scripts")
data = read.csv("/home/jean_clement/PycharmProjects/NeOmics/media/Scripts/GSE7631_loc.csv", header = T, row.names = 1)
