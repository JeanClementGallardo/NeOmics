"""
Django settings for NeOmics project.
...
SECRET_KEY = '(foo^+&1^b7f=#3xw1)q0(7d3s#i2s*k1rseg#si1*iw$x2oy0'
...
WSGI_APPLICATION = 'NeOmics.wsgi.application'
